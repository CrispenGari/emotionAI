...
n_input = n_output = 1
model_path = os.path.join(os.getcwd(), f"models/static/{AUDIO_CLASSIFIER_MODEL_NAME}")
...
audio_classifier_model.load_state_dict(torch.load(model_path, map_location=device))
